...
var peerConn = null;
var wsc = new WebSocket('ws://my-web-domain.de/websocket/');
var peerConnCfg = {'iceServers': [{'url': 'stun:stun.services.mozila.com'}, {'url': 'stun:stun.l.google.com:19302'}]};
...
wsc.onmessage = function (evt) {
  ...
  if (signal.sdp) {
    ...
    peerConn.addIceCandidates(new RTCIceCandidate(signal.candidate));
